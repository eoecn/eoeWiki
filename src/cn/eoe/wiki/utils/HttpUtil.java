...
public class HttpUtil {
	 ...
	 */
	public static String get(String url) throws IllegalStateException, ClientProtocolException, HttpResponseException, IOException{
		return get(url, null);
	}
	 ...
	 * @throws HttpResponseException
	 */
	public static String post(String url, Map<String, String> data) throws IllegalStateException, HttpResponseException, IOException  {
	...
	public static String put(String url, Map<String, String> data) throws IllegalStateException, ClientProtocolException, HttpResponseException, IOException  {
	...
	public static String delete(String url, Map<String, String> data) throws IllegalStateException, ClientProtocolException, HttpResponseException, IOException {
	...
	private static String processEntity(HttpResponse response) throws IllegalStateException, IOException
	{
